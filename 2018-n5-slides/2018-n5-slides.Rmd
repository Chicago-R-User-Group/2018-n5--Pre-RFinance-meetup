...
Leading up to this meetup, we reached **`r NROW(member_list)`** members.
As of yesterday's close, that's `r new_mem_counter(member_list)[NROW(new_mem_counter(member_list)), 2]` new members since our last meetup.
